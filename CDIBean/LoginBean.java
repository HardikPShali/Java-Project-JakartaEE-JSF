         ...
         if(roles.contains("Admin"))
           {
               ...
               HttpSession session=(HttpSession)context.getExternalContext().getSession(true);
                ...
                Login l=lb.getAllUserWiseEmail(emailid);
                session.setAttribute("id",l.getEmailid());
                 session.setAttribute("lid",l.getLid());
             
              return "AdminSite/dashboard.jsf?faces-redirect=true";
           }
       ...
       else if(roles.contains("User"))
           {
               ...
               request.getSession().setAttribute("logged-group", "User");
                ...
                session.setAttribute("lid",l.getLid());
                session.setAttribute("id",l.getEmailid());
               return "ClientSite/index.jsf?faces-redirect=true";
           }
...
//   public String getuname(Integer lid){
//        Login l = new Login();
//        GenericType<Login> gl = new GenericType<Login>(){};
//        res = lc.getLoginById_XML(Response.class,lid+"");
//        l = res.readEntity(gl);
...
//        HttpServletResponse response = (HttpServletResponse) FacesContext.getCurrentInstance().getExternalContext().getResponse();
//      
//        request.getSession().setAttribute("uname", l.getUsername()); 
//        }
//        catch (Exception e)
//        {
//             message = "Not Done";
