...
public class feedbackClient {
    ...
    public feedbackClient(String token) {
    ...
    public void addfeedback_XML(Object requestEntity, String lid, String policyid, String msg) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("addfeedback/{0}/{1}/{2}", new Object[]{lid, policyid, msg})).request(javax.ws.rs.core.MediaType.APPLICATION_XML).post(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_XML));
    }

    public void addfeedback_JSON(Object requestEntity, String lid, String policyid, String msg) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("addfeedback/{0}/{1}/{2}", new Object[]{lid, policyid, msg})).request(javax.ws.rs.core.MediaType.APPLICATION_JSON).post(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_JSON));
    }
    ...
    public <T> T getAllFeedback_XML(Class<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path("getfeedback");
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }
